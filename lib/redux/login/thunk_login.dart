...
ThunkAction<AppState> loginThunkFunction(String username, String password) {
  return (Store<AppState> store) async {
    ...
    if (responseBody != null) {
      ...
      await SharedPrefUtil()
          .setString(SharedPrefUtil().name, responseBody.name);
      await SharedPrefUtil()
          .setString(SharedPrefUtil().surname, responseBody.surname);
      await SharedPrefUtil().setString(SharedPrefUtil().username, username);
      await SharedPrefUtil()
